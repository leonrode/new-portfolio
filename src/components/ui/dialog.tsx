...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-sm bg-transparent hover:bg-[--muted] backdrop-blur-sm border text-[--primary] transition-all duration-300 disabled:pointer-events-none p-2">
        <X className="h-4 w-4" />
